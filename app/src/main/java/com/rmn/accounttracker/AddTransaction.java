...
public class AddTransaction extends AppCompatActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		header.setText("Add Transaction");
	...
	public void addTransaction(View v) {
		// get access to views
				...
				TextInputEditText editTransAmount = (TextInputEditText) this.findViewById(R.id.editTransAmount);
				TextInputEditText editChequeNo = (TextInputEditText) this.findViewById(R.id.editChequeNo);
				TextInputEditText editChequeParty = (TextInputEditText) this.findViewById(R.id.editChequeParty);
				TextInputEditText editChequeDetails = (TextInputEditText) this.findViewById(R.id.editChequeDetails);
